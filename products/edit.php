    ...
    if ($name === '') {
        ...
        if ($isLegacySchema) {
            ...
            $stmt = $pdo->prepare(
                ...
                . 'category_id = :category_id, price = :price, stock = :stock, image = :image, is_active = :is_active '
                . 'WHERE id = :id'
            );
        ...
        <div class="card-body">
            ...
            <form method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="image" class="form-control" value="<?php echo htmlspecialchars($product['image'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" placeholder="https://">
                </div>
                <div class="mb-3">
