...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($name === '') {
        ...
        if ($isLegacySchema) {
            ...
            $stmt = $pdo->prepare(
                'INSERT INTO products (name, slug, description, brand, category_id, price, stock, image, is_active) '
                . 'VALUES (:name, :slug, :description, :brand, :category_id, :price, :stock, :image, :is_active)'
            );
